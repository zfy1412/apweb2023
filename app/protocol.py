...
class PHEProtocol(object):
    ...
    def phe_pow(self):
        ...
        return (PHEThirdProtocol().phe_third_mul(h1, h2) -self.c * (r2 + r1) - self.c.public_key.encrypt(r1 * r2))
    ...
    def phe_max(self, other):
        ...
        alpha, beta = PHEThirdProtocol().phe_third_max(h, h1, h2)

        return self.c + other - beta + alpha * r3 + (self.c.public_key.encrypt(1) - alpha) * r2
    def pin_boolmore(self,other):
        temp = self.c -other
        r = abs(self._generate_random())
        temp =temp * r
        return not PHEThirdProtocol().phe_third_le(temp)
...
if __name__ == '__main__':
    ...
    a=pk.encrypt(25)
    b=pk.encrypt(50)
    print(sk.decrypt(PHEProtocol(a).phe_pow()))
